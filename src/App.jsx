...
import ManageEmployees from './components/admin/manageEmployees/manageEmployees.jsx';
...
const App = () => {
  ...
  return (
    <div className="flex">
      {user && <DefaultSidebar />}
      <div className={`flex-1 ${user ? ' ml-20 lg:ml-64 w-2/3' : ''}`}>
        <Routes>
          ...
          <Route path="/admin-dashboard/manage-employees" element={<ProtectedRoute element={<ManageEmployees />} roles={['admin']} />} />
